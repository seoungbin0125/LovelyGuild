...
Lovely 길드용 대시보드입니다. 전투력/토벌전 현황, 캐릭터 모아보기, 길드 컨텐츠, 핫딜, 그리고 **실시간 토벌전 참여 확인** 기능이 포함되어 있습니다. v1.25.0부터 Lovely 전용 다크 네온 디자인을 적용했고, 광장/쉬어가기 탭은 숨겼습니다.
...
```bash
cd ~/Downloads
unzip lovely-guild-dashboard-v1.25.0.zip
